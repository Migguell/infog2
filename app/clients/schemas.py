...
class ClientCreateResponse(BaseModel):
    client: ClientResponse = Field(description="Dados do cliente criado.")
    token: Token = Field(description="Token de acesso gerado para o cliente.")

    class Config:
        json_schema_extra = {
            "example": {
                "client": ClientResponse.Config.json_schema_extra["example"],
                "token": {
